...
- Доработать lifecycle (state-machine) 🟡 в процессе
- Доработать валидацию 🟡 в процессе
- Расширить набор состояний 🟡 в процессе
- Добавить централизованное логирование 🟡 в процессе
